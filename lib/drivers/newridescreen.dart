...
class _NewRideScreenState extends State<NewRideScreen> {
  ...
  endTheTrip() async {
    ...
    if (widget.rideDetails.carRideType == "reserve") {
      fareAmount = AssistantMethods.calculateFares(directionalDetails) * 4;
    } else if (widget.rideDetails.carRideType == "delivery") {
      fareAmount = AssistantMethods.calculateFares(directionalDetails) * 4 + 20;
    }
