...
class DriverSignUpOTP extends StatefulWidget {
  final String phone;
  DriverSignUpOTP(this.phone);
  @override
  _DriverSignUpOTPState createState() => _DriverSignUpOTPState();
}

class _DriverSignUpOTPState extends State<DriverSignUpOTP> {
